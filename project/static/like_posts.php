...
$page_title = 'Bài viết đã lưu - My Blog';
$page_description = 'Danh sách các bài viết bạn đã lưu để đọc lại sau trên My Blog.';
    ...
    <div class="box-container view_all">
        ...
        ?>
                <form class="box" method="post">
                    ...
                    <div class="post-content content-30"><?= html_entity_decode((string)$fetch_posts['content'], ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?></div>
                    ...
                    <div class="icons">
                        ...
                        <button type="button"><i class="fa-solid fa-share-from-square"></i>Chia sẻ</button>
                    </div>
                </form>
        <?php
            }
